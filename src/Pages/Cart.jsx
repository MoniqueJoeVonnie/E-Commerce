      ...
      <main className="cart-page">
        ...
        {cartItems.length === 0 ? (
          <div className="empty-cart">
            ...
            <p>
              Browse our latest pet fashion and find the
              perfect look for your pup.
            </p>
          ...
          <>
                  ...
                  <div className="shipping-progress-message">
                    ...
                    {shipping === 0 ? (
                      ...
                      <span>
                        ...
                        <strong>
                          $
                          {amountUntilFreeShipping.toFixed(
                            2
                          )}
                        </strong>{" "}
            ...
            <section className="cart-recommendations">
              <div className="cart-recommendations-heading">
                ...
                <p>
                  Pair your pup’s selection with these
                  stylish favorites.
                </p>
              </div>
